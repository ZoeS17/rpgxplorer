...
#Region "Member Variables"
    ...
    Private LevelMapTable As New Hashtable(20)
                ...
                For i As Integer = LevelRange.StartClassLevel To (LevelRange.StartClassLevel + LevelRange.LevelsAdded) - 1
                    ...
                    If ClassHitDice > 0 Then
                        ...
                        For j As Integer = 1 To ClassHitDice
                            HitDice += 1
                            'LevelMapTable.Item(HitDice) = (LevelRange.StartCharacterLevel + i) - 1
...
#Region "Event Handlers"
    ...
    Private Sub RollDie_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RollDie.Click
        Try
            If Marker < LevelsToAdd Then
                ...
                If HitDiceMode Then
                    ClassObj = Levels.GetLevelRange(CInt(LevelMapTable(CurrentLevel + Marker + 1))).ClassTaken
    ...
    Private Sub RollHistory_SelectedItemChanged() Handles RollHistory.SelectedItemChanged
        ...
        Try
            ...
            If HitDiceMode Then
                classobj = Levels.GetLevelRange(CInt(LevelMapTable(CurrentLevel + RollHistory.SelectedIndex + 1))).ClassTaken
...
#Region "Helper Functions"
    ...
    Public Function AddRoll() As Boolean
        ...
        Try
            If HitDiceMode Then
                Roll.Level = CInt(LevelMapTable(CurrentLevel + Marker + 1))
            Else
    ...
    Public Sub RollAll()
        ...
        Try
            ...
            For n = CurrentLevel + 1 To CurrentLevel + LevelsToAdd
                ...
                If HitDiceMode Then
                    Classobj = Levels.GetLevelRange(CInt(LevelMapTable(n))).ClassTaken
                    DiceRange.Dice = Rules.Dice.GetDice(Classobj.Element("HitDice"))
                    DiceRange.DiceCount = 1

                    Roll.Level = CInt(LevelMapTable(n))
                    If n = 1 Then
    ...
    Public Sub UpdateRoll()
        ...
        Try
            ...
            If HitDiceMode Then
                Roll.Level = CInt(LevelMapTable(CurrentLevel + RollHistory.SelectedIndex + 1))
    ...
    Private Shadows Sub UpdateTotalHPAndButtons()
        ...
        Try
            ...
            Else
                ...
                'update the DiceRoller
                If HitDiceMode Then
                    ClassObj = Levels.GetLevelRange(CInt(LevelMapTable(CurrentLevel + Marker + Adjust))).ClassTaken
