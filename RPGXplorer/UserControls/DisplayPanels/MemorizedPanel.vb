...
#Region "IPanel"
    ...
    Public Overridable Sub RefreshPanelData() Implements IPanel.RefreshPanelData
        ...
        'generate the memorized spell slots
        Character.GenerateMemorizedSpells()

        Dim Items() As ListViewItem
        Dim ObjectList As New ArrayList

        Dim MemorizedSpell As Objects.ObjectData

        'get the objects to be displayed
        For Each MemorizedSpell In Character.MemorizedSpellsFolder.Children
            ObjectList.Add(MemorizedSpell)
        Next
            ...
            For Each Obj As Objects.ObjectData In ObjectList
                ...
                If ColumnCount > 0 Then
                    For x As Integer = 0 To ColumnCount - 1
                        Element = ListViewManager.ListViewColumnDefs.Item(Objects.MemorizedSpellsFolderType).Elements(x)
