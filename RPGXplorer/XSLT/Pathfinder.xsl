...
<!-- Character sheet based on the Pathfinder character sheet created by Paizo -->
				...
				<table width="100%" cellspacing="0" cellpadding="0">
					<tr>
						<td valign="top">
							<center>
							<img>
								<xsl:attribute name="src"><xsl:value-of select="$InstallPath"/>/xslt/images/Pathfinder/Pathfinder.jpg</xsl:attribute>
							...
							<table width="100%" cellspacing="0" cellpadding="0">
								<tr>
									<td>
										<table width="100%" cellspacing="0" cellpadding="0">
											<tr>
												<td width="44%" class="writeinline" height="20" valign="bottom"><font class="headtext"><xsl:value-of select="CharacterName"/></font></td>
											...
											<tr>
												...
												<td><font class="smalltext">Player Name</font></td>
											</tr>
										</table>
									</td>
								</tr>
								<tr>
									<td>
										<table width="100%" cellspacing="0" cellpadding="0">
											<tr>
												<td width="38%" class="writeinline" height="20" valign="bottom">
													<font class="headtext">
												...
												<td width="1%" rowspan="2"></td>
												<td width="22%" class="writeinline" height="20" valign="bottom"><font class="headtext">&#160;</font></td>
												<td width="1%" rowspan="2"></td>
												<td width="10%" class="writeinline" height="20" valign="bottom"><font class="headtext">&#160;</font></td>
											</tr>
											<tr>
												<td><font class="smalltext">Character Level</font></td>
												<td><font class="smalltext">Campaign</font></td>
								...
								<tr>
									<td>
										<table width="100%" cellspacing="0" cellpadding="0">
											...
											<tr>
												<td><font class="smalltext">Race/Template</font></td>
					...
					<tr>
						<td width="54%" valign="top">
							...
							<table width="100%" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="1%"></td>
									<td width="20%" class="v9" style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; BORDER-LEFT: black 1px solid; BORDER-BOTTOM: black 1px solid" align="right" valign="top">
										<font class="v4">MODIFIERS</font><br/><br/><br/><br/>
									</td>
								</tr>
							</table>
							<!-- /Grapple -->
						...
						<td width="45%" valign="top">
									...
									<td>
										<table width="100%" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td align="center"><font class="smalltext">Total<br/>Bonus</font></td>
												<td align="center"></td>
												<td align="center"><font class="smalltext"></font></td>
												<td align="center"><font class="smalltext">Ability<br/>Modifier</font></td>
												<td align="center"></td>
												<td align="center"><font class="smalltext">Ranks</font></td>
												<td align="center"></td>
							...
							<table width="100%" cellspacing="0" cellpadding="0">
								...
								<tr>
									<td>
										<font class="v9">CONDITIONAL MODIFIFERS:</font>
									</td>
								</tr>
								<tr>
									<td height="5"></td>
									...
									<td height="100%">
										...
										<table width="100%" cellspacing="0" cellpadding="0" border="0" height="100%">
											<tr>
												...
												<td class="v7w" align="middle" bgcolor="black">
													NEXT LEVEL
												</td>
											</tr>
											<tr>
