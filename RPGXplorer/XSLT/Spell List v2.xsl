					...
					<xsl:choose>
						<xsl:when test="ClassName = 'Wizard' or ClassName = 'Sorcerer' or ClassName = 'Bard'">
							...
							<TABLE cellSpacing="0" cellPadding="0" width="100%" align="top" bgColor="white" border="0">
								<TBODY>
									<TR>
										<TD align="middle" width="100%" bgColor="black" colSpan="3"><FONT style="FONT-SIZE: 9pt" face="Arial Black" color="white">
										...
										<xsl:if test="ClassName = $class">
											<TR>
												<TD colspan="3" align="left">
													<FONT style="FONT-SIZE: 9pt" font-weight="bold" face="Arial Black" color="black">
													Spells Per Day
													<xsl:choose>
									...
									<xsl:for-each select="Spell">
										...
										<TR>
											...
											<TD align="left" valign="top" size="140">
												<FONT style="FONT-SIZE: 10pt" face="Arial" color="black">
												<xsl:choose>
											...
											<TD valign="top" width="75%">
												...
												</xsl:choose>: <FONT style="FONT-SIZE: 10pt" face="Arial Narrow" color="black"><xsl:value-of select="Description"/></FONT><BR/></FONT>
											</TD>
											<TD align="left" width="20%" valign="top">
												<FONT style="FONT-SIZE: 10pt" face="Arial Narrow" color="black"><xsl:value-of select="Sourcebook"/>&#160;<xsl:value-of select="PageNo"/><BR/></FONT>
											</TD>
										</TR>
									</xsl:for-each>
								</TBODY>
									...
									<xsl:for-each select="Spell">
										...
										<TR>
											...
											<TD width="79%" valign="top">
												<FONT style="FONT-SIZE: 10pt" face="Arial" color="black"><B><a target="spell"><xsl:attribute name="href"><xsl:value-of select="HelpPage"/></xsl:attribute><xsl:value-of select="SpellName"/></a></B>
												<xsl:choose>
													<xsl:when test="contains(Components, 'M')">
														<sup>M</sup>
														<xsl:if test="contains(Components, 'XP')">
						...
						<TBODY>
							...
							<xsl:for-each select="Power">
								...
								<TR>
									...
									<TD width="79%" valign="top">
										<FONT style="FONT-SIZE: 10pt" face="Arial" color="black"><B><a target="power"><xsl:attribute name="href"><xsl:value-of select="HelpPage"/></xsl:attribute><xsl:value-of select="PowerName"/></a></B>
										<xsl:choose>
											<xsl:when test="contains(Components, 'M')">
												<sup>M</sup>
												<xsl:if test="contains(Components, 'XP')">
