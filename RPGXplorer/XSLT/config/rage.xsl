...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="baseragestr">
		<xsl:choose>
			...
			<xsl:when test="/CharacterXMLDataset/Character/Features/Feature/FeatureName/text()[contains(.,'Greater Rage')]">
	...
	<xsl:variable name="ragelength" select="$baseragelength + $modragelength"/>
