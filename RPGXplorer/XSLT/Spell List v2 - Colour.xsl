		...
		<HTML>
			<HEAD>
				...
				<STYLE>
					...
					.v10w {
						FONT-SIZE: 12pt; COLOR: white; FONT-FAMILY: Arial Black
					}
					.versionInfo {
			...
			<BODY bgColor="white">
					...
					<xsl:choose>
						<xsl:when test="ClassName = 'Wizard' or ClassName = 'Sorcerer' or ClassName = 'Bard'">
									...
									<TR>
										<TD vAlign="top" width="49%">
											<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
												<TBODY>
													<TR>
														<TD class="v10w" style="BORDER-LEFT: #0000A0 3px solid" align="center" bgColor="#0000A0">
							...
							<TABLE cellSpacing="0" cellPadding="0" width="100%" align="top" bgColor="white" border="0">
								<TBODY>
									<TR>
										<TD align="middle" width="100%" bgColor="#0080FF" colSpan="3"><FONT style="FONT-SIZE: 9pt" face="Arial Black" color="white">
											...
											</xsl:choose>-LEVEL <xsl:value-of select="translate(ClassName, $lcletters, $ucletters)"/> SPELLS </FONT>
										</TD>
									</TR>
										...
										<xsl:if test="ClassName = $class">
											<TR>
												<TD colspan="3" align="left">
													<FONT style="FONT-SIZE: 9pt" face="Arial Black" color="blue">
													Spells Per Day
													<xsl:choose>
									...
									<xsl:for-each select="Spell">
										...
										<TR>
											...
											<TD align="left" valign="top" size="140">
												<FONT style="FONT-SIZE: 10pt" face="Arial" color="#0080FF">
												<xsl:choose>
											...
											<TD valign="top" width="75%" class="arcane">
												<FONT style="FONT-SIZE: 10pt" face="Arial" color="#0000A0">
												<xsl:if test="$class != 'Sorcerer' and $class != 'Bard'">
													<font face="wingdings">ooooo</font>
												</xsl:if>
												<B><a target="spell"><xsl:attribute name="href"><xsl:value-of select="HelpPage"/></xsl:attribute><xsl:value-of select="SpellName"/></a></B>
												<xsl:choose>
												...
												</xsl:choose>: <FONT style="FONT-SIZE: 10pt" face="Arial Narrow" color="blue"><xsl:value-of select="Description"/></FONT><BR/></FONT>
											</TD>
											<TD align="left" width="20%" valign="top">
												<FONT style="FONT-SIZE: 10pt" face="Arial Narrow" color="#808080"><xsl:value-of select="Sourcebook"/>&#160;<xsl:value-of select="PageNo"/><BR/></FONT>
											</TD>
										</TR>
									</xsl:for-each>
								</TBODY>
						...
						<xsl:otherwise>
									...
									<TR>
										<TD vAlign="top" width="49%">
											<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
												<TBODY>
													<TR>
														<TD class="v10w" style="BORDER-LEFT: #800000 3px solid" align="center" bgColor="#800000">
															<xsl:value-of select="translate(ClassName, $lcletters, $ucletters)"/> SPELLS
															<xsl:if test="$UseSpellPoints = 'Yes'">
																<b> - Spell Points <xsl:value-of select="../../SpellCasterInfo/CasterClass[ClassName = $class]/SpellPoints"/></b>
															</xsl:if>
							...
							<TABLE cellSpacing="0" cellPadding="0" width="100%" align="top" bgColor="white" border="0">
								<TBODY>
									<TR>
										<TD align="middle" width="100%" bgColor="#ca2000" colSpan="3"><FONT style="FONT-SIZE: 9pt" face="Arial Black" color="white">
											<xsl:value-of select="SpellLevel"/>
											<xsl:choose>
												<xsl:when test="SpellLevel = '0'"/>
												<xsl:when test="SpellLevel = '1'">ST</xsl:when>
									...
									<xsl:for-each select="Spell">
										...
										<TR>
											...
											<TD align="middle"><FONT style="FONT-SIZE: 10pt" face="Arial" color="#400000"><BR/>
												</FONT>
											</TD>
											<TD width="79%" valign="top" class="divine">
												<FONT style="FONT-SIZE: 10pt" face="Arial" color="#880000"><B><a target="spell"><xsl:attribute name="href"><xsl:value-of select="HelpPage"/></xsl:attribute><xsl:value-of select="SpellName"/></a></B>
												<xsl:choose>
													<xsl:when test="contains(Components, 'M')">
														<sup>M</sup>
														<xsl:if test="contains(Components, 'XP')">
												...
												</xsl:choose>: <FONT style="FONT-SIZE: 10pt" face="Arial Narrow" color="#aa6000"><xsl:value-of select="Description"/></FONT><BR/></FONT>
											</TD>
											<TD align="left" width="20%" valign="top">
												<FONT style="FONT-SIZE: 10pt" face="Arial Narrow" color="808080"><xsl:value-of select="Sourcebook"/>&#160;<xsl:value-of select="PageNo"/><BR/></FONT>
											</TD>
				...
				<xsl:for-each select="Powers/ClassPowers[not(ClassName = preceding-sibling::ClassPowers/ClassName)]">
							...
							<TR>
								<TD vAlign="top" width="49%">
									<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TBODY>
											<TR>
												<TD class="v10w" style="BORDER-LEFT: #004000 3px solid" align="center" bgColor="#004000">
					...
					<TABLE cellSpacing="0" cellPadding="0" width="100%" align="top" bgColor="white" border="0">
						<TBODY>
							<TR>
								<TD align="middle" width="100%" bgColor="#00AA40" colSpan="3"><FONT style="FONT-SIZE: 9pt" face="Arial Black" color="white">
									...
									<xsl:choose>
										...
										<xsl:otherwise>TH</xsl:otherwise>
									</xsl:choose>-LEVEL <xsl:value-of select="translate(ClassName, $lcletters, $ucletters)"/> POWERS</FONT>
								</TD>
							</TR>
							...
							<xsl:for-each select="Power">
								...
								<TR>
									...
									<TD align="middle"><FONT style="FONT-SIZE: 10pt" face="Arial" color="black"><BR/>
										</FONT>
									</TD>
									<TD width="79%" valign="top" class="psionic">
										<FONT style="FONT-SIZE: 10pt" face="Arial" color="#004000"><B><a target="power"><xsl:attribute name="href"><xsl:value-of select="HelpPage"/></xsl:attribute><xsl:value-of select="PowerName"/></a></B>
										<xsl:choose>
											<xsl:when test="contains(Components, 'M')">
												<sup>M</sup>
												<xsl:if test="contains(Components, 'XP')">
										...
										</xsl:choose>: <FONT style="FONT-SIZE: 10pt" face="Arial Narrow" color="#008000"><xsl:value-of select="Description"/></FONT><BR/></FONT>
									</TD>
									<TD align="left" width="20%" valign="top">
										<FONT style="FONT-SIZE: 10pt" face="Arial Narrow" color="#808080"><xsl:value-of select="Sourcebook"/>&#160;<xsl:value-of select="PageNo"/><BR/></FONT>
									</TD>
