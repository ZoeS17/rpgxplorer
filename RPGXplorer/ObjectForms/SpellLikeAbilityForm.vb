...
Public Class SpellLikeAbilityForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.SpecificBonsuFeatTab.Text = "Spell Like Ability"
        '
        'SpellLevelSpin
        '
        Me.SpellLevelSpin.EditValue = New Decimal(New Integer() {0, 0, 0, 0})
        Me.SpellLevelSpin.Location = New System.Drawing.Point(325, 105)
        ...
        Me.SpellLevelSpin.TabIndex = 243
        ...
        Me.Notes.EditValue = ""
        Me.Notes.Location = New System.Drawing.Point(90, 165)
        Me.Notes.Name = "Notes"
        Me.Notes.Properties.MaxLength = 200
        Me.Notes.Size = New System.Drawing.Size(295, 50)
        Me.Notes.TabIndex = 5
        '
        'Label21
        '
        ...
        Me.CasterLevel.Location = New System.Drawing.Point(90, 75)
        ...
        Me.SpellDCLabel.Location = New System.Drawing.Point(155, 135)
        Me.SpellDCLabel.Name = "SpellDCLabel"
        Me.SpellDCLabel.Size = New System.Drawing.Size(95, 21)
        Me.SpellDCLabel.TabIndex = 183
        Me.SpellDCLabel.Text = "Final Spell DC = "
        ...
        Me.Ability.Location = New System.Drawing.Point(90, 135)
        ...
        'Caster
        '
        Me.Caster.Location = New System.Drawing.Point(90, 105)
        ...
        Me.Label3.Text = "Cast as"
        Me.Label3.TextAlign = System.Drawing.ContentAlignment.MiddleLeft
        '
        'Usage
        '
        Me.Usage.EditValue = ""
        Me.Usage.Location = New System.Drawing.Point(90, 45)
        Me.Usage.Name = "Usage"
        ...
        Me.Label12.Text = "Spell"
        Me.Label12.TextAlign = System.Drawing.ContentAlignment.MiddleLeft
        '
        'Spell
        '
        Me.Spell.Location = New System.Drawing.Point(90, 15)
        Me.Spell.Name = "Spell"
        ...
        Me.SpellLevel.Location = New System.Drawing.Point(325, 105)
        ...
        Me.SpellDC.Location = New System.Drawing.Point(240, 135)
...
#End Region
    ...
    'datalists
    Private SpellList As DataListItem()
    ...
    Public Sub Init()
        Try
            'datalists
            SpellList = Rules.Index.DataList(Xml.DBTypes.Spells, Objects.SpellDefinitionType)

            'initialise controls
            Spell.Properties.Items.AddRange(SpellList)
        ...
        Try
            ...
            Select Case mFolder.Type
                Case Objects.SpellLikeAbilityFolderType
                    mObject.Type = Objects.SpellLikeAbilityTakenType
                Case Else
                    mObject.Type = Objects.SpellLikeAbilityType
            End Select
            mObject.ParentGUID = mFolder.ObjectGUID

            'init form
            Me.Text = "Add Spell Like Ability"
    ...
    Public Sub InitEdit(ByVal Obj As Objects.ObjectData)
        Try
            ...
            'init form
            Me.Text = "Edit Spell Like Ability"
            Me.Icon = New Drawing.Icon(General.BasePath & "Icons\form_blue.ico")
            Init()

            'initialise controls
            Spell.SelectedIndex = Rules.Index.GetGuidIndex(SpellList, mObject.GetFKGuid("Spell"))
    ...
    Private Sub OK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK.Click
        Try
            If Me.Validate Then
                ...
                mObject.FKElement("Spell", Spell.Text, "Name", CType(Spell.SelectedItem, DataListItem).ObjectGUID)
    ...
    Private Sub Spell_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Spell.SelectedIndexChanged
        Try
            ...
            If Spell.SelectedIndex <> -1 Then
                ...
                Dim SpellObj As Objects.ObjectData = CType(CType(Spell.SelectedItem, DataListItem).ValueMember, Objects.ObjectData)
                Dim AllowedCasterClasses As New Objects.ObjectDataCollection

                For Each SpellLevel As Objects.ObjectData In SpellObj.ChildrenOfType(Objects.SpellLevelType)
                    If SpellLevel.Element("Class") <> "" Then
                        AllowedCasterClasses.Add(SpellLevel.GetFKObject("Class"))
                        SpellLevelLookup.Add(SpellLevel.GetFKGuid("Class"), SpellLevel.ElementAsInteger("Level"))
                    End If
                Next
            ...
            'forces the box to clear its contents if nothing is selected
