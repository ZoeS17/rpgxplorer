...
#End Region
    ...
    Public Sub InitAdd(ByVal Folder As Objects.ObjectData)
        Try
            ...
            'init new object
            mObject.ObjectGUID = Objects.ObjectKey.NewGuid(XML.DBTypes.Subtypes)
            mObject.Type = Objects.SubtypeDefinitionType
            mObject.ParentGUID = mFolder.ObjectGUID

            'init form
            Me.Text = "Add Subtype Definition"
    ...
    Public Sub InitEdit(ByVal Obj As Objects.ObjectData)
        Try
            ...
            'init form
            Me.Text = "Edit Subtype Definition"
