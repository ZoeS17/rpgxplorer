...
Public Class PsionicTattooForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.MarketPrice.Location = New System.Drawing.Point(105, 105)
        ...
        'ObjectName
        '
        Me.ObjectName.Location = New System.Drawing.Point(105, 15)
        ...
        'BaseSpell
        '
        Me.BaseSpell.Location = New System.Drawing.Point(105, 45)
...
#End Region
    ...
    Public Sub Init()
        ...
        Try
            ...
            SpellsDataList = Rules.Index.DataList(Xml.DBTypes.Powers, Objects.PowerDefinitionType)
    ...
    Public Sub InitAdd(ByVal Folder As Objects.ObjectData)
        Try
            ...
            mObject.Type = Objects.PsionicTattooDefinitionType
            mObject.ParentGUID = mFolder.ObjectGUID

            'init form
            Me.Text = "Add Psionic Tattoo"
    ...
    Public Sub InitEdit(ByVal Obj As Objects.ObjectData)
        Try
            ...
            BaseSpell.SelectedIndex = Rules.Index.GetGuidIndex(SpellsDataList, mObject.GetFKGuid("BasePower"))
    ...
    Private Sub OK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK.Click
        Try
            If Me.Validate Then
                ...
                mObject.FKElement("BasePower", BaseSpell.Text, "Name", CType(BaseSpell.SelectedItem, DataListItem).ObjectGUID)
                mObject.HTMLGUID = mObject.GetFKGuid("BasePower")
                mObject.Element("ManifesterLevel") = CasterLevel.Value.ToString
    ...
    Private Sub BaseSpell_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles BaseSpell.SelectedIndexChanged
        Try
            If Suggest.Checked Then
                ...
                ObjectName.Text = "Tattoo of " & BaseSpell.Text
            End If
        Catch ex As Exception
            Throw New Exception(ex.Message, ex)
        End Try
