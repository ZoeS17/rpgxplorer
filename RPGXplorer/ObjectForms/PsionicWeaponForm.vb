...
Public Class PsionicWeaponForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.SpecificTab.Text = "Psionic Weapon"
        '
        'DMaterialDropdown
        '
        ...
        Me.DMaterialDropdown.TabIndex = 361
        '
        'DMaterialLabel
        '
        ...
        Me.DMaterialLabel.TabIndex = 362
        ...
        Me.AbilityDropdown.Location = New System.Drawing.Point(100, 45)
        ...
        Me.DLabel3.Size = New System.Drawing.Size(95, 21)
        Me.DLabel3.TabIndex = 244
        Me.DLabel3.Text = "Special Ability"
        ...
        Me.DAbilityDropdown.Location = New System.Drawing.Point(115, 75)
        ...
        Me.Name = "PsionicWeaponForm"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Psionic Weapon"
...
#End Region
    ...
    Public Sub Init()
        ...
        Try
            ...
            'AbilityDataList = Rules.Index.DataListExclude(Xml.DBTypes.WeaponMagicAbilities, Objects.PsionicWeaponAbilityDefinitionType, Exclusions)
            AbilityList = New ArrayList(Rules.Index.DataListExclude(XML.DBTypes.WeaponMagicAbilities, Objects.PsionicWeaponAbilityDefinitionType, Exclusions))
            AbilityList.AddRange(Rules.Index.DataListExclude(XML.DBTypes.WeaponMagicAbilities, Objects.WeaponMagicAbilityDefinitionType, Exclusions))
    ...
    Public Sub InitAdd(ByVal Folder As Objects.ObjectData)
        Try
            ...
            mObject.Type = Objects.PsionicWeaponDefinitionType
            mObject.ParentGUID = mFolder.ObjectGUID

            'init form
            Me.Text = "Add Psionic Weapon"
    ...
    Public Sub InitEdit(ByVal Obj As Objects.ObjectData)
        ...
        Try
            ...
            DExistingAbilities = mObject.ChildrenOfType(Objects.PsionicWeaponAbilityDoubleType)
            For Each Child In DExistingAbilities
                DCurrentAbilities.Add(Child)
                DAbilityListBox.AddItem(Child.Name, Child.ObjectGUID)
                DAbilityEnhancement += Child.GetFKObject("WeaponAbility").ElementAsInteger("PriceBonus")
            Next
        ...
        Try
            ...
            If DEnhancementBonus.Value = 0 Then
                ...
                For Each Ability As Objects.ObjectData In DCurrentAbilities
                    Dim AbilityObj As Objects.ObjectData = Ability.GetFKObject("WeaponAbility")
...
#Region "Double Weapon Abilities"
    ...
    Private Sub DAddAbility_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DAddAbility.Click
        ...
        Try
            ...
            If Not DCurrentAbilities.ContainsFK("WeaponAbility", CType(DAbilityDropdown.SelectedItem, DataListItem).ObjectGUID) Then

                Obj = DExistingAbilities.Item("WeaponAbility", CType(DAbilityDropdown.SelectedItem, DataListItem).ObjectGUID)

                If Obj.IsEmpty Then
                    Obj.Name = DAbilityDropdown.Text
                    Obj.Type = Objects.PsionicWeaponAbilityDoubleType
                    Obj.ObjectGUID = Objects.ObjectKey.NewGuid(XML.DBTypes.MagicWeapons)
                    Obj.ParentGUID = mObject.ObjectGUID
                    Obj.FKElement("WeaponAbility", DAbilityDropdown.Text, "Name", CType(DAbilityDropdown.SelectedItem, DataListItem).ObjectGUID)
                End If
    ...
    Private Sub DRemoveAbility_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DRemoveAbility.Click
        ...
        Try
            ...
            Obj = DCurrentAbilities.Item(DAbilityListBox.ItemGUID).GetFKObject("WeaponAbility")
            Select Case Obj.Element("PriceType")
                Case "Specific"
                    'do nothing
                Case Else
...
#Region "Cost and Enhancement"
    ...
    Private Sub CalculatePrice()
        Dim Weapon As New Objects.ObjectData, AbilityDef As Objects.ObjectData
        Dim Price As Money
