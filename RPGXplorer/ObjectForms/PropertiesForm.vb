...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(PropertiesForm))
...
#End Region
    ...
    'member vars
    Private _Objs As Objects.ObjectDataCollection

    'init
    Public Sub Init(ByVal Objs As Objects.ObjectDataCollection)
        Try
            _Objs = Objs
            PropertiesTab.InitForMultiple(Objs)
    ...
    Private Sub OK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK.Click
        Dim Guids As ArrayList

        Try
            General.MainExplorer.Undo.UndoRecord()
            PropertiesTab.UpdateMultipleObjects()
            Guids = _Objs.GetGuidList
            General.MainExplorer.RefreshPanel()
            General.MainExplorer.SelectGroup(Guids)
            Me.Close()
        Catch ex As Exception
            Throw New Exception(ex.Message, ex)
        End Try
