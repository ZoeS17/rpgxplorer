...
Public Class SpecificArmorForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.SpecificTab.Text = "Magic Armor or Shield"
        '
        'MaterialDropdown
        '
        ...
        Me.MaterialDropdown.TabIndex = 347
        '
        'Label6
        '
        ...
        Me.Name = "SpecificArmorForm"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Specific Armor"
...
#End Region
    ...
    Public Sub Init()
        ...
        Try
            ...
            AbilityDataList = Rules.Index.DataList(Xml.DBTypes.ArmorMagicAbilities, Objects.ArmorMagicAbilityDefinitionType)
    ...
    Public Sub InitAdd(ByVal Folder As Objects.ObjectData)
        Try
            ...
            mObject.Type = Objects.SpecificArmorDefinitionType
            mObject.ParentGUID = mFolder.ObjectGUID

            'init form
            Me.Text = "Add Magic Armor or Shield"
    ...
    Public Sub InitEdit(ByVal Obj As Objects.ObjectData)
        ...
        Try
            ...
            'int form
            Me.Text = "Edit Magic Armor or Shield"
            ...
            ExistingAbilities = mObject.ChildrenOfType(Objects.SpecificArmorAbilityType)
            For Each Child In ExistingAbilities
                CurrentAbilities.Add(Child)
                AbilityListBox.AddItem(Child.Name, Child.ObjectGUID)
                Ability = Child.GetFKObject("ArmorMagicAbility")
...
#Region "Magic Armor Tab"
    ...
    'Load the AdilityDropdowns with the legal ability choices, Remove any abilities that are no longer valid, Load the material dropdown with the legal choices
    ...
    Private Sub CalculatePrice()
        ...
        Try
            ...
            For Each SpecialAbility In CurrentAbilities
                AbilityDef = SpecialAbility.GetFKObject("ArmorMagicAbility")
...
#Region "Abilities Tab"
    ...
    Private Sub AddAbility_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AddAbility.Click
        ...
        Try
            ...
            If Not CurrentAbilities.ContainsFK("ArmorMagicAbility", CType(AbilityDropdown.SelectedItem, DataListItem).ObjectGUID) Then

                Obj = ExistingAbilities.Item("ArmorMagicAbility", CType(AbilityDropdown.SelectedItem, DataListItem).ObjectGUID)

                If Obj.IsEmpty Then
                    Obj.Name = AbilityDropdown.Text
                    Obj.Type = Objects.SpecificArmorAbilityType
                    Obj.ObjectGUID = Objects.ObjectKey.NewGuid(Xml.DBTypes.MagicArmor)
                    Obj.ParentGUID = mObject.ObjectGUID
                    Obj.FKElement("ArmorMagicAbility", AbilityDropdown.Text, "Name", CType(AbilityDropdown.SelectedItem, DataListItem).ObjectGUID)
                End If
    ...
    Private Sub RemoveAbility_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles RemoveAbility.Click
        ...
        Try
            ...
            AbilityDef = Obj.GetFKObject("ArmorMagicAbility")
    ...
    Private Sub UpdateAbilitiesList(ByVal ArmorObj As Objects.ObjectData)
        ...
        Try
            ...
            For Each tempobj In CurrentAbilities
                AbilityObj = tempobj.GetFKObject("ArmorMagicAbility")
