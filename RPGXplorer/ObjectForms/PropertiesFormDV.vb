...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(PropertiesFormDV))
...
#End Region
    ...
    'member vars
    Private _Obj As Objects.ObjectData

    'init
    Public Sub Init(ByVal Obj As Objects.ObjectData)
        Try
            _Obj = Obj
            PropertiesTab.Init(Obj, FormMode.Edit)
    ...
    Private Sub OK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK.Click
        Try
            _Obj = PropertiesTab.UpdateObject(_Obj)
            _Obj.Save()
            Me.Close()
        Catch ex As Exception
            Throw New Exception(ex.Message, ex)
